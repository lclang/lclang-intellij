...
public interface lclangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link lclangParser#namedType}.
	 * @param ctx the parse tree
	 */
	void enterNamedType(lclangParser.NamedTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link lclangParser#namedType}.
	 * @param ctx the parse tree
	 */
